...
export default function NestedCta({
  ...
  return (
    <Link
      href={href}
      className={`group inline-flex w-fit items-center gap-3 rounded-full py-2 pl-6 pr-2 font-body text-sm transition-[background-color] duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] active:scale-[0.98] ${
        light
