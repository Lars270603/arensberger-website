...
export default function SubHero({ eyebrow, title, subtitle, imageLabel, image }: SubHeroProps) {
  return (
    <section className="relative flex h-[70vh] min-h-[480px] w-full items-end overflow-hidden">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 pb-16 sm:px-6 lg:px-10">
        <Reveal>
          <span className="mb-5 inline-flex w-fit items-center gap-2 rounded-full border border-white/30 bg-white/10 px-4 py-1.5 font-body text-[10px] uppercase tracking-[0.25em] text-white backdrop-blur-2xl">
            {eyebrow}
          </span>
        </Reveal>
        <Reveal delay={100}>
