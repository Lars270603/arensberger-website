...
export const mattressCategories: MattressCategory[] = [
  ...
  {
    title: "Gelschaum",
    teaser: "Aktiver Kühleffekt und Druckentlastung — für alle die nachts zu warm schlafen.",
    href: "/matratzen/gelschaum",
    image: "/images/gelschaummatratze.jpg",
  },
  {
    title: "Kinder",
    teaser: "Ergonomisch entwickelt für gesunden Schlaf von Anfang an.",
    href: "/matratzen/kinder",
    image: "/images/kinderreisebett.jpg",
  },
  {
    title: "Kaltschaum",
    teaser: "Punktelastisch und langlebig — passt sich an ohne nachzugeben.",
    href: "/matratzen/kaltschaum",
    image: "/images/kaltschaummatratze.jpg",
  },
  {
    title: "Topper",
    teaser: "Das Upgrade für deine bestehende Matratze — ohne sie zu ersetzen.",
